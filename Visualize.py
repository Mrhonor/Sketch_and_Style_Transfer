...
def show_data_distribution(npoints=80, batch_size=64, dimension=2):
    ...
    for i in range(50, 550, 50):
        netG.load_state_dict(torch.load('GAN_file/netG_epoch_'+str(i)+'.pth'))
        fake = netG(noise)
...
if __name__ == "__main__":
    ...
    # ConvVisualization('Discriminator', 'GAN_file/netD_epoch_500.pth')
    # ConvVisualization('Generator', 'GAN_file/netG_epoch_500.pth')
    pass
