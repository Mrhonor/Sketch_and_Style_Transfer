...
class TrainOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--exp_name', type=str, default="../ST_files", help='the name of experiment')
        ...
        self.parser.add_argument('--data_root', type=str, default="../ST_Dataset", help='directory of the dataset')
